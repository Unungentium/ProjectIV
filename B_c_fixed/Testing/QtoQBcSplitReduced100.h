// -*- C++ -*-
#ifndef Herwig_QtoQBcSplitReduced100_H
#define Herwig_QtoQBcSplitReduced100_H
//
// This is the declaration of the QtoQBcSplitReduced100 class.
//
...
/**
 * Here is the documentation of the QtoQBcSplitReduced100 class.
 *
 * @see \ref QtoQBcSplitReduced100Interfaces "The interfaces"
 * defined for QtoQBcSplitReduced100.
 */
class QtoQBcSplitReduced100: public SudakovFormFactor {
...
public:
   ...
   */
  QtoQBcSplitReduced100();

  /**
   * The destructor.
   */
  virtual ~QtoQBcSplitReduced100();
  //@}
...
aa   * @param identical Whether or not the outgoing particles are identical
...
private:
   ...
   */
  QtoQBcSplitReduced100 & operator=(const QtoQBcSplitReduced100 &);

};

}

#endif /* Herwig_QtoQBcSplitReduced100_H */
