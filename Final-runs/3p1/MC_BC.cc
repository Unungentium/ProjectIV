...
namespace Rivet {
  ...
  public:
	...
	_h_rap_Bc->fill(p.momentum().rapidity());
      ...
      Particles particles3p1 = apply<UnstableFinalState>(event,"UFS").particles(Cuts::abspid==20543);
      for(auto p: particles3p1) {
    ...
    */
    ...
    /// @name Histograms
    ///@{
    Histo1DPtr _h_pT_Bc,_h_rap_Bc, _h_pT_3p1, _h_rap_3p1;
    ///@}
