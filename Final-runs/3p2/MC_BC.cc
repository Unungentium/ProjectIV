...
namespace Rivet {
  ...
  public:
	...
	_h_rap_Bc->fill(p.momentum().rapidity());
      ...
      Particles particles3p2 = apply<UnstableFinalState>(event,"UFS").particles(Cuts::abspid==545);
      for(auto p: particles3p2) {
    ...
    */
    ...
    /// @name Histograms
    ///@{
    Histo1DPtr _h_pT_Bc,_h_rap_Bc, _h_pT_3p2, _h_rap_3p2;
    ///@}
