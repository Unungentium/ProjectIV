...
namespace Rivet {
  ...
  public:
    ...
    void init() {
      ...
      book(_h_pT_1p0,"h_pT_1p0",100,0.,30.);
      book(_h_rap_1p0,"h_rap_1p0",100,-10.,10.);
	...
	_h_rap_Bc->fill(p.momentum().rapidity());
      ...
      Particles particles1p0 = apply<UnstableFinalState>(event,"UFS").particles(Cuts::abspid==10543);
      for(auto p: particles1p0) {
	_h_pT_1p0 -> fill(p.momentum().perp());
	_h_rap_1p0 -> fill(p.momentum().rapidity());
    ...
    */
    ...
    void finalize() {
      ...
      scale(_h_pT_1p0, crossSection()/picobarn/sumW());
      scale(_h_rap_1p0,crossSection()/picobarn/sumW());
    ...
    /// @name Histograms
    ///@{
    Histo1DPtr _h_pT_Bc,_h_rap_Bc, _h_pT_1p0, _h_rap_1p0;
    ///@}
