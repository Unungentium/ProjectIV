// -*- C++ -*-
#ifndef Herwig_QtoQBcSplit3p1_H
#define Herwig_QtoQBcSplit3p1_H
//
// This is the declaration of the QtoQBcSplit3p1 class.
//
...
/**
 * Here is the documentation of the QtoQBcSplit3p1 class.
 *
 * @see \ref QtoQBcSplit3p1Interfaces "The interfaces"
 * defined for QtoQBcSplit3p1.
 */
class QtoQBcSplit3p1: public SudakovFormFactor {
...
public:
  ...
  double P(const double z, const Energy2 t,
    ...
    double x=(24*pow(-1 + a2,2)*pow(a2,3)*pow<6,1>(M))/
      pow<3,1>(t) - (4*(-1 + a2)*a2*pow<4,1>(M)*
      (2 + a2*(5 - 11*z) + 
        2*pow(a2,3)*(-1 + z) - 
        pow(a2,2)*(5 - 8*z + pow(z,2))))/
      (pow<2,1>(t)*(1 + a2*(-1 + z))) + 
   (3*z*(6 - 2*pow(a2,3)*(-3 + z)*
         pow(-1 + z,3) + 
        pow(a2,4)*pow(-1 + z,4) - 8*z + 
        3*pow(z,2) + 
        pow(a2,2)*pow(-1 + z,2)*
         (15 - 8*z + pow(z,2)) + 
        2*a2*(-8 + 15*z - 8*pow(z,2) + 
           pow(z,3))))/pow(1 + a2*(-1 + z),4)
      - (3*pow<2,1>(M)*
      (-3 + 2*pow(a2,4)*pow(-1 + z,3) + 
        9*z - 2*pow(a2,3)*pow(-1 + z,2)*
         (3 + z) - 2*a2*
         (2 - 5*z + 5*pow(z,2)) + 
        pow(a2,2)*
         (15 - 35*z + 19*pow(z,2) + pow(z,3))
        ))/(2.*t*pow(1 + a2*(-1 + z),2));
    return x;
  }
  ...
  double ratioP(const double z, const Energy2 t,
    ...
    Energy M = ids[0]->mass()+ids[1]->mass();
    double a2 = ids[0]->mass()/M;
    double x=z/v*(1-sqr(z))*((24*pow(-1 + a2,2)*pow(a2,3)*pow<6,1>(M))/
      pow<3,1>(t) - (4*(-1 + a2)*a2*pow<4,1>(M)*
      (2 + a2*(5 - 11*z) + 
        2*pow(a2,3)*(-1 + z) - 
        pow(a2,2)*(5 - 8*z + pow(z,2))))/
...
private:
   ...
   */
  QtoQBcSplit3p1 & operator=(const QtoQBcSplit3p1 &);

};

}

#endif /* Herwig_QtoQBcSplit3p1_H */
