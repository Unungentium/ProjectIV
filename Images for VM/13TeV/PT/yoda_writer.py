...
aos=OrderedDict()
mid=io.open("13TeVPT_center.dat", mode="r", encoding="utf-8")
upp=io.open("13TeVPT_top.dat", mode="r", encoding="utf-8")

right=io.open("13TeVPT_right.dat", mode="r", encoding="utf-8")
# book histo
...
"""for val in aos :
    print val,aos[val]"""
# write the file
yoda.writeYODA(aos,"LHCB_2019_I1762092_PT.yoda")
